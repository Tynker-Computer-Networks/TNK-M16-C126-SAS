...
def generateReceipt():
    ...
    # Get JSON order data from the request
    data = request.json
    order_index = data['index']

    # Assuming 'orders' is a list of orders stored in the session
...
def generatePdf(order_data):
    ...
    # Add content to the PDF (replace this with your specific receipt format)
    pdf_canvas.drawString(100, 800, f"Order Receipt")
    pdf_canvas.drawString(100, 780, f"------------------------")

    total_amount = 0  # Initialize the overall total amount
